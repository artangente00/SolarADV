...
@Entity
@Table(name = "AdditionalInfoFiles")
public class AdditionalInfoFiles {

	@Id
	@SequenceGenerator(name="additionalfiles_seq", sequenceName = "additionalfiles_seq", allocationSize = 1)
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="additionalfiles_seq")  
	private Long id;
