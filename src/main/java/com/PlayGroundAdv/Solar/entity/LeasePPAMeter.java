...
@Entity
@Table(name = "LeasePPAMeter")
public class LeasePPAMeter {
	...
	private static final long serialVersionUID = 1L;
		...
		public String toString() {
			return "LeasePPAMeter [id=" + id + ", manufacturer=" + manufacturer + ", model=" + model + ", mappedValue="
					+ mappedValue + ", includeTLD=" + includeTLD + ", updated=" + updated + ", isDeleted=" + isDeleted
