...
@Entity
@Table(name = "PermitConduitConductorSectionEntity")
public class PermitConduitConductorSectionEntity {
...
private static final long serialVersionUID = 1L;
	...
	@Id
	@SequenceGenerator(name="hibernate_sequence16", sequenceName = "hibernate_sequence16", allocationSize = 1)
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="hibernate_sequence16")  
	private Long id;
	...
	@Column(name="IMG_SEGMENT_ONE")
	private String imgSegmentOne;
	
	@Column(name="IMG_SEGMENT_TWO")
	private String imgSegmentTwo;
	
	@Column(name="IMG_SEGMENT_THREE")
	private String imgSegmentThree;
	
	@Column(name="IMG_SEGMENT_FOUR")
	private String imgSegmentFour;
	
	@Column(name="IMG_SEGMENT_FIVE")
	private String imgSegmentFive;
	
	@Column(name="IMG_SEGMENT_SIX")
	private String imgSegmentSix;
	
	@Column(name="IMG_SEGMENT_SEVEN")
	private String imgSegmentSeven;
	
	@Column(name="IMG_SEGMENT_EIGHT")
	private String imgSegmentEight;
	
	@Column(name="IMG_SEGMENT_NINE")
	private String imgSegmentNine;
	...
	@Column(name="QTY_SEGMENT_ONE")
	private Integer qtySegmentOne;
	
	@Column(name="QTY_SEGMENT_TWO")
	private Integer qtySegmentTwo;
	
	@Column(name="QTY_SEGMENT_THREE")
	private Integer qtySegmentThree;
	
	@Column(name="QTY_SEGMENT_FOUR")
	private Integer qtySegmentFour;
	
	@Column(name="QTY_SEGMENT_FIVE")
	private Integer qtySegmentFive;
	
	@Column(name="QTY_SEGMENT_SIX")
	private Integer qtySegmentSix;
	
	@Column(name="QTY_SEGMENT_SEVEN")
	private Integer qtySegmentSeven;
	
	@Column(name="QTY_SEGMENT_EIGHT")
	private Integer qtySegmentEight;
	
	@Column(name="QTY_SEGMENT_NNE")
	private Integer qtySegmentNine;
	
	@Column(name="QTY_SEGMENT_TEN")
	private Integer qtySegmentTen;
	
	@Column(name="QTY_SEGMENT_ELEVEN")
	private Integer qtySegmentEleven;
	...
	@Column(name="MAP_FROM_USER_INPUT")
	private Boolean mapFromUserInput;
	
	@Column(name="QTY_SEGMENT_NNE_TWO")
	private Integer qtySegmentNineTwo;
	...
	@Column(name="IMG_SEGMENT_NINE_TWO")
	private String imgSegmentNineTwo;
    ...
    /* CR-3227-MOD-001 */
	@Column
	private Boolean circuitEnvironmentChanged;
	
	@Column
	private Boolean circuitEnvironmentTwoChanged;
	
	@Column
	private Boolean circuitEnvironmentThreeChanged;
	
	@Column
	private Boolean circuitEnvironmentFourChanged;
	
	@Column
	private Boolean circuitEnvironmentFiveChanged;
	
	@Column
	private Boolean circuitEnvironmentSixChanged;
	
	@Column
	private Boolean circuitEnvironmentSevenChanged;
	
	@Column
	private Boolean circuitEnvironmentEightChanged;
	
	@Column
	private Boolean circuitEnvironmentNineChanged;
	
	@Column
	private Boolean circuitEnvironmentNineTwoChanged;
	
	@Column
	private Boolean circuitEnvironmentTenChanged;
	
	@Column
	private Boolean circuitEnvironmentElevenChanged;
	
	@Column
	private Boolean circuitEnvironmentTwelveChanged;

	/* CR-3227-MOD-003 */
	
	@Column
	private Float circuitLengthOne;
	
	@Column
	private Float circuitLengthTwo;
	
	@Column
	private Float circuitLengthThree;
	
	@Column
	private Float circuitLengthFour;
	
	@Column
	private Float circuitLengthFive;
	
	@Column
	private Float circuitLengthSix;
	
	@Column
	private Float circuitLengthSeven;
	
	@Column
	private Float circuitLengthEight;
	
	@Column
	private Float circuitLengthNine;
	
	@Column
	private Float circuitLengthNineTwo;
	
	@Column
	private Float circuitLengthTen;
	
	@Column
	private Float circuitLengthEleven;
	
	@Column
	private Float circuitLengthTwelve;
}
