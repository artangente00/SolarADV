...
@Entity
@Table(name = "ProposedSubPanel")
public class ProposedSubPanel {
	...
	private static final long serialVersionUID = 1L;
		...
		public String toString() {
			return "ProposedSubPanel [id=" + id + ", manufacturer=" + manufacturer + ", model=" + model
					+ ", typeSubPanel=" + typeSubPanel + ", polesNumber=" + polesNumber + ", nemaRating=" + nemaRating
					+ ", ratedCurrent=" + ratedCurrent + ", dropdownOption=" + dropdownOption + ", sheetFileName="
					+ sheetFileName + ", updated=" + updated + ", isDeleted=" + isDeleted + ", hasSuperUserEdit="
					+ hasSuperUserEdit + ", addDate=" + addDate + ", authentificationEntity=" + authentificationEntity
