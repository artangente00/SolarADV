...
@Entity
@Table(name = "RoofAttachmentsEntity")
public class RoofAttachmentsEntity {


private static final long serialVersionUID = 1L;
	
	@Id
	@SequenceGenerator(name="stan_sequence", sequenceName = "stan_sequence", allocationSize = 1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="stan_sequence") 
	private Long id;
	...
	@Column(name="NUMBER_OF_ROOF")
	private String numberOfRoof;
	
	
	@Column(name="UTILIZE_S100")
	...
	public String toString() {
		return "RoofAttachmentsEntity [id=" + id + ", manufacturer=" + manufacturer + ", model=" + model + ", weight="
				+ weight + ", integrated=" + integrated + ", roofType=" + roofType + ", numberOfRoof=" + numberOfRoof
				+ ", utilizeS100=" + utilizeS100 + ", lastUpdate=" + lastUpdate + ", isDeleted=" + isDeleted
				+ ", hasSuperUserEdit=" + hasSuperUserEdit + ", addDate=" + addDate + ", idOwner=" + idOwner
