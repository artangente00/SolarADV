...
public class FlashingFavRequest {
	...
	public FlashingFavRequest() {
		super();
	}

	public FlashingFavRequest(Long id, String isFav, String manufacturer, String model, String mappedValue,
			String weight, String updated, Boolean isDeleted, AuthentificationEntity owner,
	...
	public String toString() {
		return "FlashingFavRequest [id=" + id + ", isFav=" + isFav + ", manufacturer=" + manufacturer + ", model="
				+ model + ", mappedValue=" + mappedValue + ", weight=" + weight + ", updated=" + updated
