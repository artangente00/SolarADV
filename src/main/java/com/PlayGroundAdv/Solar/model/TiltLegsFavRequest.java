...
public class TiltLegsFavRequest {
	...
	public TiltLegsFavRequest() {
		super();
	}

	public TiltLegsFavRequest(Long id, String isFav, String manufacturer, String model, String weight, String updated,
			Boolean isDeleted, AuthentificationEntity owner, Boolean hasCorrectionRequest, String eroneousContent,
			String eroneousContentOther, String eroneousDescription) {
		super();
		this.id = id;
		this.isFav = isFav;
	...
	public String toString() {
		return "TiltLegsFavRequest [id=" + id + ", isFav=" + isFav + ", manufacturer=" + manufacturer + ", model="
				+ model + ", mappedValue=" + ", weight=" + weight + ", updated=" + updated + ", isDeleted=" + isDeleted
