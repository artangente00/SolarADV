...
@Getter
@Setter
public class AHJACDiscoModel {
	private String acdisconnectRequired;
	private String acdiscoOtherRequirement;
	private List<String> notes;
	
	public List<ResultUpdateLog> compareFields(AHJACDiscoModel object) throws IllegalAccessException{
	    ...
	    for(Field field : fields){
	        try {
	        	if(!field.getName().equals("notes") && field.get(this) != null && !field.get(this).equals(field.get(object))){
		            ...
		            resultObject.setCategory("AC Disco");
