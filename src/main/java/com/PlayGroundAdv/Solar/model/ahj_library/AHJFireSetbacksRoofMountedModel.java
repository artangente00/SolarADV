...
@Getter
@Setter
public class AHJFireSetbacksRoofMountedModel {
	...
	public List<ResultUpdateLog> compareFields(AHJFireSetbacksRoofMountedModel object) throws IllegalAccessException{
	    ...
	    for(Field field : fields){
	        try {
	        	if(!field.getName().equals("notes") && field.get(this) != null && !field.get(this).equals(field.get(object))){
		            ...
		            resultObject.setCategory("Fire Setbacks roof mounted");
