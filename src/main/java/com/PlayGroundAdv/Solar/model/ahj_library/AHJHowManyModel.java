...
@Getter
@Setter
public class AHJHowManyModel {
	private Integer qtyOfWeStampPlansets;
	private Integer wetStampSetsOfCalcs;
	private List<String> notes;
	
	public List<ResultUpdateLog> compareFields(AHJHowManyModel object) throws IllegalAccessException{
	    ...
	    for(Field field : fields){
	        try {
	        	if(!field.getName().equals("notes") && field.get(this) != null && !field.get(this).equals(field.get(object))){
		            ...
		            resultObject.setCategory("How Many");
