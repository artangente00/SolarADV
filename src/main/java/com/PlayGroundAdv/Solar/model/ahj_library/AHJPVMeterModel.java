...
@Getter
@Setter
public class AHJPVMeterModel {
	private String isPVMeterRequired;
	private String pvMeterLocationFromLtToRt;
	private List<String> notes;
	
	public List<ResultUpdateLog> compareFields(AHJPVMeterModel object) throws IllegalAccessException{
	    ...
	    for(Field field : fields){
	        try {
	        	if(!field.getName().equals("notes") && field.get(this) != null && !field.get(this).equals(field.get(object))){
		            ...
		            resultObject.setCategory("PV Meter (Generation Meter)");
