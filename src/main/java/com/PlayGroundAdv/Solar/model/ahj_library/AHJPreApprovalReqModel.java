...
@Getter
@Setter
public class AHJPreApprovalReqModel {
	private String hoaApprovalRequired;
	private String utilityWorkOrderReqForServiceUpgrade;
	private String utilityPreApprovalReqBeforeSubmittal;
	private List<String> notes;
	
	public List<ResultUpdateLog> compareFields(AHJPreApprovalReqModel object) throws IllegalAccessException{
	    ...
	    for(Field field : fields){
	        try {
	        	if(!field.getName().equals("notes") && field.get(this) != null && !field.get(this).equals(field.get(object))){
		            ...
		            resultObject.setCategory("Pre-Approval Req's");
