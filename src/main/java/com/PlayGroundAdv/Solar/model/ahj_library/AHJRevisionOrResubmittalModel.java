...
@Getter
@Setter
public class AHJRevisionOrResubmittalModel {
	private String revisionFormRequired;
	private String needOriginalStampedPlansForResubmittal;
	private List<String> notes;
	
	public List<ResultUpdateLog> compareFields(AHJRevisionOrResubmittalModel object) throws IllegalAccessException{
	    ...
	    for(Field field : fields){
	        try {
	        	if(!field.getName().equals("notes") && field.get(this) != null && !field.get(this).equals(field.get(object))){
		            ...
		            resultObject.setCategory("Revision or Resubmittal");
