...
@Getter
@Setter
public class AHJRoofMountRelatedRequirementOnlyModel {
	...
	public List<ResultUpdateLog> compareFields(AHJRoofMountRelatedRequirementOnlyModel object) throws IllegalAccessException{
	    ...
	    for(Field field : fields){
	        try {
	        	if(!field.getName().equals("notes") && field.get(this) != null && !field.get(this).equals(field.get(object))){
		            ...
		            resultObject.setCategory("Structural - Roof Mount Related Requirements Only");
