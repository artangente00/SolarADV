...
@Getter
@Setter
public class AHJUsedByClientsModel {
	...
	public List<ResultUpdateLog> compareFields(AHJUsedByClientsModel object) throws IllegalAccessException{
	    ...
	    for(Field field : fields){
	        try {
	        	if(!field.getName().equals("notes") && field.get(this) != null && !field.get(this).equals(field.get(object))){
		            ...
		            resultObject.setCategory("Used by Clients");
