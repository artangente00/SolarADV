...
@Getter
@Setter
public class AHJWaterIntrusionModel {
	private String callOutSealerTypeOnPlanset;
	private String sealerInfoRequired;
	private List<String> notes;
	
	public List<ResultUpdateLog> compareFields(AHJWaterIntrusionModel object) throws IllegalAccessException{
	    ...
	    for(Field field : fields){
	        try {
	        	if(!field.getName().equals("notes") && field.get(this) != null && !field.get(this).equals(field.get(object))){
		            ...
		            resultObject.setCategory("Water Intrusion");
