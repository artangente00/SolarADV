...
@Getter
@Setter
public class GoverningCodesModel {
	...
	public List<ResultUpdateLog> compareFields(GoverningCodesModel object) throws IllegalAccessException{
	    ...
	    for(Field field : fields){
	        try {
	        	if(!field.getName().equals("notes") && field.get(this) != null && !field.get(this).equals(field.get(object))){
		            ...
		            resultObject.setCategory("Governing codes");
