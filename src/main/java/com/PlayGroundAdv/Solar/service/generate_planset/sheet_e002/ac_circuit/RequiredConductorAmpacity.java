...
@Service
public class RequiredConductorAmpacity {
	...
	public RequiredConductorAmpacity(CheckValueTypesService checkValue, TechnicalProblemMsg technicalProblemMsg,
	...
	public E002Model mapACrequiredAmpacity(AcroFields form, int i, int indexAcCombiner, Boolean stepACCombiner,
			...
			String acCircuit, E002Model params) {
		try {
